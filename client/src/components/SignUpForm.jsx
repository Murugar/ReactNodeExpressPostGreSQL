  ...
  render () {
    ...
    return (
      ...
      <form onSubmit={ this.onSubmit }>
        <h1 className="text-center text-danger">Join</h1>
        ...
        <section className={classnames("form-group", { 'has-error': errors.timezone })}>
          <label className="control-label text-primary">Time Zone</label>
          <select
        ...
        <section className="form-group">
          <button disabled={ this.state.isLoading || this.state.invalid } className="btn btn-primary">
            Sign Up
          </button>
            &nbsp;&nbsp;
           <button onClick={ this.onCancel } className="btn btn-warning">
            Cancel
          </button>  
        </section>
      </form>
